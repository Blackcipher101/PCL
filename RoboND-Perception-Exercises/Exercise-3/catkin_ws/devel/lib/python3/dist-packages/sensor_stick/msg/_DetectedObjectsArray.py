...
"""autogenerated by genpy from sensor_stick/DetectedObjectsArray.msg. Do not edit."""
import codecs
import sys
...
"""
  __slots__ = ['objects']
  _slot_types = ['sensor_stick/DetectedObject[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = sensor_stick.msg.DetectedObject()
        start = end
        end += 4
        (length,) = _struct_I.unpack(str[start:end])
        start = end
